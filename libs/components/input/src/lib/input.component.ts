...
export class InputComponent implements ControlValueAccessor, AfterContentInit {
  ...
  @Input() public disabledOptions = false; //desativar as opções do combo (mas mostrando ele)
  ...
  public valid(): boolean {
    ...
    const _errors = { ...this.formControl.errors, error: false };
  ...
  private fullNameValidator(
    ...
    const _error = { fullNameValidator: true };
